System.register(['angular2/core', 'angular2/http', 'angular2/router', 'rxjs/Rx', 'a2-in-memory-web-api/core', '../api/in-memory-story.service', './characters/characters', './dashboard/dashboard', './vehicles/vehicles', './shared/shared', './blocks/blocks'], function(exports_1) {
    "use strict";
